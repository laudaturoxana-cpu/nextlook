...
const FREE_SHIPPING_THRESHOLD = 9999 // TEST: dezactivat livrare gratuita
const SHIPPING_COST_RAPID = 1 // TEST: 1 leu
const SHIPPING_COST_RAMBURS = 0 // TEST: 0 lei ramburs
